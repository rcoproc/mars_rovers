...
yystate(4, Ics, Line, Tlen, _, _) ->
    {3,Tlen,Ics,Line,4};
yystate(3, [87|Ics], Line, Tlen, Action, Alen) ->
    yystate(0, Ics, Line, Tlen+1, Action, Alen);
yystate(3, [83|Ics], Line, Tlen, Action, Alen) ->
    yystate(0, Ics, Line, Tlen+1, Action, Alen);
yystate(3, [82|Ics], Line, Tlen, Action, Alen) ->
    yystate(1, Ics, Line, Tlen+1, Action, Alen);
yystate(3, [78|Ics], Line, Tlen, Action, Alen) ->
    yystate(0, Ics, Line, Tlen+1, Action, Alen);
yystate(3, [76|Ics], Line, Tlen, Action, Alen) ->
    yystate(1, Ics, Line, Tlen+1, Action, Alen);
...
-file("src/input_lexer.xrl", 8).
yyaction_0(TokenChars, TokenLine) ->
     { token, { int, TokenLine, list_to_integer (TokenChars) } } .

-compile({inline,yyaction_1/2}).
-file("src/input_lexer.xrl", 9).
yyaction_1(TokenChars, TokenLine) ->
     { token, { direction, TokenLine, TokenChars } } .

-compile({inline,yyaction_2/2}).
-file("src/input_lexer.xrl", 10).
yyaction_2(TokenChars, TokenLine) ->
     { token, { command, TokenLine, TokenChars } } .

-compile({inline,yyaction_3/0}).
-file("src/input_lexer.xrl", 11).
yyaction_3() ->
     skip_token .
